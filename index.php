...
//file_put_contents($f, <head></head>"<meta charset='utf-8'>", FILE_APPEND | LOCK_EX);
...
if(isset($head)){
    ...
    //$wordsBody2 =  get_lowerCase_words_length_high_then_two_of_text($head, $separateurs2);
...
//echo(sizeof($wordsTitle));
//echo(sizeof($wordsTitleF));
